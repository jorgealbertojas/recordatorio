...
public class sql_select {
	...
	public static String GET_ALIMENTOS =
			" SELECT ID, DESCRICAO, ID_ALUNO, CODIGO, ALIMENTO_REFEICAO  " +
					" FROM ALIMENTO  "+
					" WHERE ID_ALUNO = ? ";
	...
	public static String GET_RESPOSTA_OPCAO_QUANTIDADE_MEDIDAS = "SELECT R.ID_ALUNO, R.ID_PERGUNTA, R.ID_OPCAO, O.VALOR AS VALOROPCAO, R.VALOR AS VALORRESPOSTA, O.OPCAO   FROM RESPOSTA R, OPCAO O"+
			" WHERE R.ID_OPCAO = O.ID_OPCAO AND R.ID_ALUNO = ? AND R.ID_PERGUNTA = ? AND O.OPCAO = 'Qual a quantidade da medida caseira utilizada? (ex.: 1 colher de sopa, 2 colheres de sopa, 3 colheres de sopa)' ORDER BY R.ID_PERGUNTA, R.ID_OPCAO ";
