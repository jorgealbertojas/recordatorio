...
public class alimentos implements Serializable {
    ...
    public List<com.example.jorgealberto.cadeconsumo.modelJson.medidasCaseiras> getMedidasCaseiras() {
        return medidasCaseiras;
    }

    public void setMedidasCaseiras(List<com.example.jorgealberto.cadeconsumo.modelJson.medidasCaseiras> medidasCaseiras) {
