...
public class sql_select {
	...
	public static String GET_ALIMENTOS_REFEICAO_ALL =
			" SELECT ID, DESCRICAO, ID_ALUNO, CODIGO, ALIMENTO_REFEICAO, QUAL_E_ESSE_ITEM  " +
					" FROM ALIMENTO  "+
					" WHERE ID_ALUNO = ? and ALIMENTO_REFEICAO_ORDER = ? ";
	...
	public static String GET_ALIMENTO_REFEICAO =
			" SELECT ALIMENTO_REFEICAO  FROM ALIMENTO ORDER BY ALIMENTO_REFEICAO_ORDER DESC ";

	public static String GET_ALIMENTO_REFEICAO_ORDER =
	...
	public static String GET_RESPOSTA_OPCAO_MEDIDA_CASEIRA_2 = "SELECT R.ID_ALUNO, R.ID_PERGUNTA, R.ID_OPCAO, O.VALOR AS VALOROPCAO, R.VALOR AS VALORRESPOSTA, O.OPCAO   FROM RESPOSTA R, OPCAO O"+
			" WHERE R.ID_OPCAO = O.ID_OPCAO AND R.ID_ALUNO = ? AND R.ID_ALIMENTO = ? AND O.OPCAO = '" + VariavelAPI.constante_descricao_medida_caseira_1 + "' ORDER BY R.ID_PERGUNTA, R.ID_OPCAO ";
	...
	public static String GET_RESPOSTA_NOME = "SELECT R.ID_ALUNO, R.ID_PERGUNTA, R.ID_OPCAO, O.VALOR AS VALOROPCAO, R.VALOR AS VALORRESPOSTA, O.OPCAO   FROM RESPOSTA R, OPCAO O"+
			" WHERE R.ID_OPCAO = O.ID_OPCAO AND R.ID_ALUNO = ? AND O.ID_OPCAO =  '" + VariavelAPI.constant_chave_1014 + "'  ORDER BY R.ID_PERGUNTA, R.ID_OPCAO ";
